...
var debugCamera = new THREE.PerspectiveCamera(75, window.innerWidth / window.innerHeight,
    0.1, 1000)
...
room = new THREE.Mesh(
    new THREE.BoxBufferGeometry(cubeLanes * 2, (cubeGrid.height -
        cubeSpacing) * 1.5, 1, cubeLanes, cubeAmount - 1, 1),
